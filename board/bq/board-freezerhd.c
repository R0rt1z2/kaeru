...
void board_early_init(void) {
    printf("Entering early init for BQ Aquaris M10 HD\n");
}

void board_late_init(void) {
    printf("Entering late init for BQ Aquaris M10 HD\n");
    ...
    addr = SEARCH_PATTERN(LK_START, LK_END, 0xB508, 0x4B0A, 0x447B);
    if (addr) {

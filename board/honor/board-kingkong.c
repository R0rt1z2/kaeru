...
void board_early_init(void) {
    printf("Entering early init for Honor X30 Max\n");
    ...
    FORCE_RETURN(0x48214D30, 0);
}

void board_late_init(void) {
    printf("Entering late init for Honor X30 Max\n");
    ...
    WRITE32(0x484E0008 + 0x104, 1);
    WRITE32(0x484E0008 + 0x108, 1);
    WRITE32(0x484E0008 + 0x10C, 1);
    WRITE32(0x484E0008 + 0x114, 1);

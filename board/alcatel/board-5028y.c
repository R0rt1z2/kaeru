//
// SPDX-FileCopyrightText: 2025 PuszekReksio-mtk <hopladupla1@gmail.com>
...
void board_early_init(void) {
    printf("Entering early init for Alcatel 1S 2020\n");
}

void board_late_init(void) {
    printf("Entering late init for Alcatel 1S 2020\n");
    ...
    addr = SEARCH_PATTERN(LK_START, LK_END, 0xB508, 0xF7EF, 0xF899);
    if (addr) {

//
// SPDX-FileCopyrightText: 2026 Evelyn Torres <lostentrepreneur439@yahoo.com>
...
void board_early_init(void) {
    printf("Entering early init for OmniPod 5 PDM\n");
}

void board_late_init(void) {
    printf("Entering late init for OmniPod 5 PDM\n");

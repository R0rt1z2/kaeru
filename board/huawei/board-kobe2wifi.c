...
long partition_write(const char* part_name, long long offset, const uint8_t* data, size_t size) {
    return ((long (*)(const char*, long long, const uint8_t*, size_t))(0x48079868 | 1))(part_name, offset, data, size);
}

void cmd_reboot(const char* arg, void* data, unsigned sz) {
    ((void (*)(const char*, void*, unsigned))(0x4803265C | 1))(arg, data, sz);
}

void mt_power_off(void) {
    ((void (*)(void))(0x4800FFF8 | 1))();
}
...
void board_late_init(void) {
    ...
    FORCE_RETURN(0x4802871C, 1);
    FORCE_RETURN(0x480286EC, 1);
    ...
    if (get_bootmode() == BOOTMODE_FASTBOOT) {
        ...
        NOP(0x48031086, 2); // register fastboot reboot recovery.
        NOP(0x4803105E, 2); // register fastboot reboot.

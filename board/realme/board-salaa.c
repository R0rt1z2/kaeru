...
void board_early_init(void) {
    printf("Entering early init for Realme 7\n");
    ...
    addr = SEARCH_PATTERN(LK_START, LK_END, 0xF00D, 0xFA4D, 0xF8DF);
    if (addr) {
    ...
    addr = SEARCH_PATTERN(LK_START, LK_END, 0xF00D, 0xFA34, 0xF7FF);
    if (addr) {
...
void board_late_init(void) {
    printf("Entering late init for Realme 7\n");

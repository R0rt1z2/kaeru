...
static void show_basic_menu(void)
{
    ...
    mt_disp_show_boot_logo(); // splash logo instead of black screen
	video_set_cursor(video_get_rows()/2, 0); // Mid-left
    video_printf("========= Fastboot Mode ========= \n");
	video_printf("--------------------------------- \n");
	video_printf("Volume UP   - Continue to System  \n");
	video_printf("Volume Down - Reboot to Recovery  \n");
...
void board_early_init(void) {
    ...
    PATCH_MEM(0x4C429B7C, 0xE7E7); // removed unnecessary 5 sec delay in cmd_continue
    ...
    // function fastboot_oem_lock_chk(1). We can also force return this fumction. But it 
